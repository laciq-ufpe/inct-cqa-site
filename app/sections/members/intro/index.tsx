    ...
    return (
        <div className="w-full pt-30 pb-15 relative flex justify-left">
            ...
            <div className="px-10 md:px-30 z-2">
                ...
                <p className="text-md w-4/5 md:w-3/5 mt-5 text-lg font-medium">Conheça os pesquisadores e coordenadores que lideram esta iniciativa de colaboração acadêmica.</p>
            </div>
        </div>
    );
}
