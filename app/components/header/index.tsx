...
const Header = () => {
    ...
    return (
        <div className="w-full lg:px-30 md:px-10 px-0 md:mt-5 fixed top-0 z-10">
            <div
                className="
                    w-full h-20 md:rounded-2xl bg-neutral-800/25
                    relative flex flex-row items-center justify-between"
            >
                <div
                    className="
                        w-full h-20 rounded-2xl bg-red-800/25 blur-lg absolute top-0 z-1
                    "
                ></div>
                <h1 className="font-bold text-xl ml-10 md:ml-20 z-2">INCT-CQA</h1>
                <div className="flex flex-row gap-x-7 mr-10 md:mr-20 z-2">
                    <NavLink to={"/"}>
